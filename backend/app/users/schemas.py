...
class MeResponse(BaseModel):
    ibm_extension: Optional[IBMExtension] = Field(
        default=None, alias="urn:ietf:params:scim:schemas:extension:ibm:2.0:User"
    )
...
class CustomAttributeOperation(BaseModel):
    op: Literal["add"] = "add"
    path: Literal[
...
class NotifyTypeOperation(BaseModel):
    op: Literal["add"] = "add"
    path: Literal[
        "urn:ietf:params:scim:schemas:extension:ibm:2.0:Notification:notifyType"
    ] = "urn:ietf:params:scim:schemas:extension:ibm:2.0:Notification:notifyType"
    value: str
...
class PatchRequest(BaseModel):
    schemas: List[str] = ["urn:ietf:params:scim:api:messages:2.0:PatchOp"]
    Operations: List[Union[Operation, CustomAttributeOperation, NotifyTypeOperation]]
